         ...
         <div className='login_right_div'>
            ...
            <form >
                <div className='input_content'>
                   ...
                   <div className='input_div'> <input className='input' type='text' required></input></div>     
                </div>
                <div className='input_content'>
                   <label >Email:</label>
            ...
            <Link><p className='link_p_tag'>already have an account before?</p> </Link>

            <div className='p_div'> <p> or register with</p></div>

            <div className='google_btn'>
                <button 
                  disabled={isSigningIn}
                onClick={(e) => { onGoogleSignIn(e) }}>
                    <FcGoogle size={30}/>Google</button></div>
            </div>
